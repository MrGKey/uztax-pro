...
export default function Profile() {
  ...
  return (
    <PullToRefresh onRefresh={handleRefresh}>
      ...
      {/* Chat Support */}
      <div className="card fade-in-d4">
        <div className="settings-item" onClick={() => { haptic("impact"); window.open("https://t.me/SoliqPay_bot?start=help", "_blank"); }} style={{ cursor: "pointer" }}>
          <div className="settings-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
          </div>
          <span className="settings-label">Чат с поддержкой</span>
          <span className="settings-arrow">{Icons.arrowRight}</span>
        </div>
      </div>
